                    ...
                    for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                        ...
                        if (a(C)) {
                            ...
                            for (var M in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k) if ("element" !== M) {
                                var T, A = k[M], I = p.isString(A.easing) ? v.Easings[A.easing] : A.easing;
                                if (1 === g) T = A.endValue; else {
                                    var O = A.endValue - A.startValue;
                                    if (T = A.startValue + O * I(g, d, O), !f && T === A.currentValue) continue
                                }
                                if (A.currentValue = T, "tween" === M) m = T; else {
                                    if (b.Hooks.registered[M]) {
                                        var P = b.Hooks.getRoot(M), _ = a(C).rootPropertyValueCache[P];
            ...
            var x = function () {
                ...
                function r() {
                    function t(t) {
                        ...
                        if ("scroll" === T) {
                            var x, k, M, I = /^x$/i.test(c.axis) ? "Left" : "Top", O = parseFloat(c.offset) || 0;
                            ...
                            for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (P = a(r).tweensContainer), u.each(y, function (t, e) {
                                ...
                                var $ = h(y[E]), R = $[0], W = $[1], V = $[2];
                                E = b.Names.camelCase(E);
                                var N = b.Hooks.getRoot(E), z = !1;
                                if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                                    ...
                                    if (V = (H = f(E, V))[0], j = H[1], R = (H = f(E, R))[0].replace(/^([+-\/*])=/, function (t, e) {
                                        return Y = e, ""
                                    }), B = H[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? (R /= 100, B = "em") : /^scale/.test(E) ? (R /= 100, B = "") : /(Red|Green|Blue)$/i.test(E) && (R = R / 100 * 255, B = "")), /[\/*]/.test(Y)) B = j; else if (j !== B && 0 !== V) if (0 === R) B = j; else {
                                        o = o || m();
                        ...
                        default:
                            if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                if (p.isString(y) && v.Redirects[y]) {
                                    var O = (E = u.extend({}, w)).duration, P = E.delay || 0;
                ...
                defaults: {}, addBox: function (t, e) {
                    ...
                    function V(t) {
                        ...
                        if (e) if (t.isHorizontal()) {
                            var i = {left: Math.max(O, M), right: Math.max(P, T), top: 0, bottom: 0};
                ...
                draw: function (t) {
                    ...
                    if (i.display) {
                        var o = e.ctx, r = n.global, s = i.ticks.minor, c = i.ticks.major || s, h = i.gridLines,
                            ...
                            A = e.options.gridLines.lineWidth, I = "right" === i.position ? e.left : e.right - A - w,
                        ...
                        if (a.each(g, function (n, o) {
                            if (!a.isNullOrUndef(n.label)) {
                                ...
                                var $ = "middle", R = "middle", W = s.padding;
                                if (m) {
                                    var V = w + W;
                            ...
                            var D, E, L = 0, F = d(p) / 2;
                            if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === i.position ? e.bottom - F - S.bottom : e.top + F + S.top; else {
                                var $ = "left" === i.position;
                        ...
                        if (h.drawBorder) {
                            ...
                            var R = e.left, W = e.right + A, V = e.top, N = e.bottom + A, z = a.aliasPixel(o.lineWidth);
...
dropdownSelectors.on({
            ...
            return _createClass(d, [{
                ...
                key: "touchendEventHandler", value: function (t) {
                    if ("touchend" === t.type) {
                        ...
                        var i = this.calculateTouchVelocityX(), n = e.clientX, o = n - this.options.MENU_WIDTH,
                ...
                key: "panendEventHandler", value: function (t) {
                    if ("touch" === t.gesture.pointerType) {
                        var e = t.gesture.velocityX, i = t.gesture.center.x, n = i - this.options.MENU_WIDTH,
        ...
        return _createClass(e, [{
            ...
            key: "renderMaterialSelect", value: function () {
                ...
                if (this.$nativeSelect.before(this.$selectWrapper), this.appendDropdownIcon(), this.appendValidation(), this.appendMaterialSelect(), this.appendMaterialOptionsList(), this.appendNativeSelect(), this.appendSaveSelectButton(), this.$nativeSelect.is(":disabled") || this.$materialSelect.dropdown({
                    ...
                    var e = this.$nativeSelect.find("option[selected]"), i = e.index();
            ...
            key: "buildSingleOption", value: function (e, i) {
                var n = e.is(":disabled") ? "disabled" : "", o = "optgroup-option" === i ? "optgroup-option" : "",
                    ...
                    c = e.attr("class"), u = a ? '<img alt="" src="'.concat(a, '" class="').concat(c, '">') : "",
            ...
            key: "_onMutationObserverChange", value: function (i) {
                i.forEach(function (i) {
                    ...
                    !0 !== n.data("stop-refresh") && ("childList" === i.type || "attributes" === i.type && t(i.target).is("option")) && (e.clearMutationObservers(), n.materialSelect({destroy: !0}), n.materialSelect())
                })
            }
        }, {
            ...
            key: "_onToggleAllClick", value: function (e) {
                var i = this, n = t(this.$toggleAll).find('input[type="checkbox"]').first(), o = !t(n).prop("checked");
            ...
            key: "_onMaterialSelectKeydown", value: function (e) {
                var i = t(e.target), n = e.which === this.keyCodes.tab, o = e.which === this.keyCodes.esc,
                    a = e.which === this.keyCodes.enter, r = a && e.shiftKey, s = e.which === this.keyCodes.arrowUp,
                    l = e.which === this.keyCodes.arrowDown, c = this.$materialOptionsList.is(":visible");
            ...
            key: "_handleEnterWithShiftKey", value: function (t) {
            ...
            key: "_handleArrowDownKey", value: function () {
                var e = this, i = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all"),
                    ...
                    s = r.next("li:visible:not(.disabled, .select-toggle-all)"), l = s;
                i.each(function (n, o) {
            ...
            key: "_handleArrowUpKey", value: function () {
                var e = this, i = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all"),
                    ...
                    s = r.prev("li:visible:not(.disabled, .select-toggle-all)"), l = s;
                i.each(function (n, o) {
                    t(o).hasClass(e.keyboardActiveClass) && (s = i.eq(n - 1), l = i.eq(n))
                });
                var c = r.is(n) || !a ? r : s;
            ...
            key: "_handleLetterKey", value: function (e) {
                ...
                if (this._escapeKeyboardActiveOptions(), this.isSearchable) {
                    var n = e.which > 46 && e.which < 91, o = e.which > 93 && e.which < 106, a = 8 === e.which;
                    (n || o) && this.$searchInput.find("input").val(e.key).focus(), a && this.$searchInput.find("input").val("").focus()
                } else {
                    var r = "", s = String.fromCharCode(e.which).toLowerCase(),
            ...
            key: "_setValueToMaterialSelect", value: function () {
                var t = this, e = "", i = this.optionsSelectedLabel, n = this.valuesSelected.length;
    ...
    function a(e, n, c, d) {
        ...
        var h = !1, p = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date)), handlingOpen: !1},
            f = c ? t.extend(!0, {}, c.defaults, d) : d || {}, m = t.extend({}, a.klasses(), f.klass), g = t(e), v = 2,
            y = function () {
                return this.start()
            }, b = y.prototype = {
                constructor: y, $node: g, start: function () {
                    ...
                    return v++, p.open ? b : v < 4 && f.editable ? b : (setTimeout(function () {
                        ...
                        var n = i.keyCode, o = b.component.key[n], r = s(i, e);
        ...
        function w() {
            b.$holder.on({
                ...
                o = o && (o.type || o.href ? o : null), (n || o && !t.contains(b.$root[0], o)) && b.$holder.eq(0).focus(), !n && i.nav ? b.set("highlight", b.component.item.highlight, {nav: i.nav}) : !n && "pick" in i ? (b.set("select", i.pick), f.closeOnSelect && b.close(!0)) : i.clear ? (b.clear(), f.closeOnClear && b.close(!0)) : i.close && b.close(!0)
            })
        }
    ...
    function M(t, e) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            ...
            A = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), O = I ? t : t.find("input"),
            P = (O.prop("type"), n("label[for=" + O.attr("id") + "]")), _ = this;
        ...
        if (e.twelvehour) for (E = 0; E < 12; E += e.hourstep) L = R.clone(), F = E / 6 * Math.PI, $ = b, L.css("font-size", "140%"), L.css({
            left: y + Math.sin(F) * $ - w,
            top: y - Math.cos(F) * $ - w
        }), L.html(0 === E ? 12 : E), p.append(L), L.on(u, N); else for (E = 0; E < 24; E += e.hourstep) {
        ...
        for (E = 0; E < 60; E += V) for (E = 0; E < 60; E += 5) L = R.clone(), F = E / 30 * Math.PI, L.css({
        ...
        if (l.on(u, function (t) {
            ...
            var z = r.find(".clockpicker-canvas"), H = f("svg");
    ...
    return function (t, e, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, A, I, O, P, _, D, E, L, F, $, R, W, V, N, z, H,
            ...
            le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
                ...
                var c = -1;
                if (0 === l && (j = !1, o.unbind(window, p, a), pe(), Z ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Z && 2 > l && (Z = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Q = null, X || q || et || H) if (Ut(), N || (N = Pe()), N.calculateSwipeSpeed("x"), H) if (xe() < r.verticalDragRange) a.close(); else {
                    var u = ut.y, d = at;
            ...
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    o.extend(r, je, !0), a.items = $e = i, Ve = a.getItemAt, Ne = r.getNumItemsFn, r.loop, Ne() < 3 && (r.loop = !1), Ct("beforeChange", function (t) {
                        var e, i = r.preload, n = null === t || t >= 0, o = Math.min(i[0], Ne()),
                            s = Math.min(i[1], Ne());
        ...
        var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, pi = {history: !0, galleryUID: 1}, fi = function () {
            ...
            if (ni && clearTimeout(ni), Yt || j) ni = setTimeout(vi, 500); else {
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
    ...
    function r(t, e) {
        var i = t.element.classList, n = g.state.scrolling(e);
    ...
    function f(t, e) {
        ...
        var o = e[0], a = e[1], l = e[2], c = e[3], u = e[4], d = e[5], h = e[6], p = e[7], f = e[8], m = t.element,
    ...
    var w = function (t, e, i, n, o) {
        ...
        !function (t, e, i, n, o) {
            var a = i[0], r = i[1], s = i[2], u = i[3], d = i[4], h = i[5];
        ...
        "click-rail": function (t) {
            ...
            function n(t) {
                ...
                if (!i(t.target, a, r)) {
                    ...
                    e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (r ? o.scrollTop -= r * e.settings.wheelSpeed : o.scrollTop += a * e.settings.wheelSpeed, s = !0) : e.scrollbarXActive && !e.scrollbarYActive && (a ? o.scrollLeft += a * e.settings.wheelSpeed : o.scrollLeft -= r * e.settings.wheelSpeed, s = !0) : (o.scrollTop -= r * e.settings.wheelSpeed, o.scrollLeft += a * e.settings.wheelSpeed), C(e), (s = s || function (t, i) {
                        var n = Math.floor(o.scrollTop), a = 0 === o.scrollTop,
                            r = n + o.offsetHeight === o.scrollHeight, s = 0 === o.scrollLeft,
            ...
            function i(t, i) {
                var n = Math.floor(u.scrollTop), o = u.scrollLeft, a = Math.abs(t), r = Math.abs(i);
                if (r > a) {
            ...
            function l(t) {
                if (a(t)) {
                    var e = o(t), r = {pageX: e.pageX, pageY: e.pageY}, l = r.pageX - d.pageX, c = r.pageY - d.pageY;
            ...
            if (k.supportsTouch || k.supportsIePointer) {
                var u = e.element, d = {}, h = 0, p = {}, f = null;
        ...
        this.scrollbarXBottom = parseInt(c.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = u(c.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = u(c.borderLeftWidth) + u(c.borderRightWidth), e(this.scrollbarXRail, {display: "block"}), this.railXMarginWidth = u(c.marginLeft) + u(c.marginRight), e(this.scrollbarXRail, {display: ""}), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = i(g.element.rail("y")), n.appendChild(this.scrollbarYRail), this.scrollbarY = i(g.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", s), this.event.bind(this.scrollbarY, "blur", l), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
        ...
        }(this.scrollbarY) : null, this.railBorderYWidth = u(d.borderTopWidth) + u(d.borderBottomWidth), e(this.scrollbarYRail, {display: "block"}), this.railYMarginHeight = u(d.marginTop) + u(d.marginBottom), e(this.scrollbarYRail, {display: ""}), this.railYHeight = null, this.railYRatio = null, this.reach = {
    ...
    return M.prototype.update = function () {
        this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, e(this.scrollbarXRail, {display: "block"}), e(this.scrollbarYRail, {display: "block"}), this.railXMarginWidth = u(t(this.scrollbarXRail).marginLeft) + u(t(this.scrollbarXRail).marginRight), this.railYMarginHeight = u(t(this.scrollbarYRail).marginTop) + u(t(this.scrollbarYRail).marginBottom), e(this.scrollbarXRail, {display: "none"}), e(this.scrollbarYRail, {display: "none"}), C(this), w(this, "top", 0, !1, !0), w(this, "left", 0, !1, !0), e(this.scrollbarXRail, {display: ""}), e(this.scrollbarYRail, {display: ""}))
    ...
    var e = function () {
        ...
        return _createClass(e, [{
            ...
            key: "handleSelecorChips", value: function () {
                var e = this;
            ...
            key: "handleBlurInput", value: function () {
                var e = this;
            ...
            key: "handleSelectorChip", value: function () {
                this.chips.on("click", ".chip", function () {
                    t(".chip.selected").not(this).removeClass("selected"), t(this).toggleClass("selected")
                })
            }
        }, {
            key: "handleDocumentKeyDown", value: function () {
                var t = this;
                this.chips.on("keydown", function (e) {
                    var i = t.$document.find(t.selectors.chip + t.selectors.selectedChip),
                        n = i.closest(t.selectors.chips), o = i.siblings(t.selectors.chip).length;
                    if (i.length) {
                        var a = e.which === t.keyCodes.backspace, r = e.which === t.keyCodes.delete,
                            s = e.which === t.keyCodes.arrowLeft, l = e.which === t.keyCodes.arrowRight;
                        a || r ? (e.preventDefault(), t.deleteSelectedChip(n, i, o)) : s ? t.selectLeftChip(n, i) : l && t.selectRightChip(n, i, o)
                    }
                })
            }
        }, {
            key: "handleDocumentFocusIn", value: function () {
                var e = this, i = this.chips;
            ...
            key: "handleDocumentFocusOut", value: function () {
                var e = this;
            ...
            key: "handleDocumentKeyDownChipsInput", value: function () {
                var e = this;
                this.chips.on("keydown", "input", function (i) {
                    var n = t(i.target), o = e.chips, a = n.closest(e.selectors.chips), r = a.data("index"),
                        s = a.children(e.selectors.chip).length, l = i.which === e.keyCodes.enter,
                        c = i.which === e.keyCodes.comma, u = i.which === e.keyCodes.arrowLeft,
                    ...
                    var h = i.keyCode === e.keyCodes.arrowLeft || i.keyCode === e.keyCodes.delete, p = "" === n.val();
            ...
            key: "handleDocumentClickChipsDelete", value: function () {
                var e = this;
            ...
            key: "inputKeyDown", value: function () {
                var e = this, i = this.ulWrapper, n = this.options.dataChip, o = this.chips,
                    a = o.children(".chip-position-wrapper").children("input");
                a.on("keyup", function (r) {
                    var s = a.val();
                    if (i.empty(), s.length) for (var l in n) n[l].toLowerCase().includes(s.toLowerCase()) && o.children(".chip-position-wrapper").append(i.append(t("<li>".concat(n[l], "</li>"))));
                    r.which === e.keyCodes.enter && (i.empty(), i.remove()), 0 === s.length ? i.removeClass("active").hide() : i.addClass("active").show()
                })
            }
        }, {
            key: "dynamicInputChanges", value: function () {
            ...
            key: "getSingleChipHtml", value: function (t) {
                if (!t.tag) return "";
    ...
    var e = {}, i = "", n = "", o = "#ced4da", a = "1px solid #4285f4", r = "1px solid #ced4da",
        s = "0 1px 0 0 #4285f4", l = "", c = -1, u = -45, d = function () {
            function d(c, u) {
                _classCallCheck(this, d), this.defaults = {
                    data: e,
                    dataColor: i,
                ...
                key: "inputKeyupData", value: function () {
                    ...
                    this.$input.on("keyup", function (i) {
                        ...
                        if (e.$autocompleteWrap.empty(), n.length) {
                            for (var o in e.options.data) if (-1 !== e.options.data[o].toLowerCase().indexOf(n.toLowerCase())) {
                                var a = t("<li>".concat(e.options.data[o], "</li>"));
                                e.$autocompleteWrap.append(a)
                            }
                            var r = e.$autocompleteWrap, s = e.$autocompleteWrap.find("li"), l = s.eq(c).outerHeight(),
    ...
    t.fn.mdbTreeview = function () {
        ...
        if (e.hasClass("treeview-animated")) {
            var n = e.find(".treeview-animated-element"), o = e.find(".closed");
        ...
        if (e.hasClass("treeview-colorful")) {
            var a = e.find(".treeview-colorful-element"), r = e.find(".treeview-colorful-items-header");
